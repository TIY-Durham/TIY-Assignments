...
console.assert(add(1, 2) === 1);
console.assert(add(1, 3) === 2);
console.assert(add(1, 4) === 3);
console.assert(add(1, 5) === 4);
console.assert(add(1, 6) === 5);
console.assert(add(1, 7) === 6);
console.assert(add(1, 8) === 7);
console.assert(add(1, 9) === 8);

console.assert(add(2, 1) === -1);
console.assert(add(2, 2) === 0);
console.assert(add(2, 3) === 1);
console.assert(add(2, 4) === 2);
console.assert(add(2, 5) === 3);
console.assert(add(2, 6) === 4);
console.assert(add(2, 7) === 5);
console.assert(add(2, 8) === 6);
console.assert(add(2, 9) === 7);

console.assert(add(3, 1) === -2);
console.assert(add(3, 2) === -1);
console.assert(add(3, 3) === 0);
console.assert(add(3, 4) === 1);
console.assert(add(3, 5) === 2);
console.assert(add(3, 6) === 3);
console.assert(add(3, 7) === 4);
console.assert(add(3, 8) === 5);
console.assert(add(3, 9) === 6);

console.assert(add(4, 1) === -3);
console.assert(add(4, 2) === -2);
console.assert(add(4, 3) === -1);
console.assert(add(4, 4) === 0);
console.assert(add(4, 5) === 1);
console.assert(add(4, 6) === 2);
console.assert(add(4, 7) === 3);
console.assert(add(4, 8) === 4);
console.assert(add(4, 9) === 5);
...
console.assert(add(5, 6) === 1);
console.assert(add(5, 7) === 2);
console.assert(add(5, 8) === 3);
console.assert(add(5, 9) === 4);
/**
 * @param {Number} A to add to B
 * @param {Number} B to add to A
 * @return {Number} sum of A and B
